...
class TestImportanceRanker:
    ...
    def test_rank_basic_messages(self):
        ...
        from agentmemory.compression import ImportanceRanker
...
class TestTruncateStrategy:
    ...
    def test_no_compression_needed(self):
        ...
        from agentmemory.compression import TruncateStrategy, TokenCounter
...
class TestSummarizeStrategy:
    ...
    def test_rule_based_summarize(self):
        ...
        from agentmemory.compression import SummarizeStrategy, TokenCounter
...
class TestExtractKeyFactsStrategy:
    ...
    def test_extract_facts_rule_based(self):
        ...
        from agentmemory.compression import ExtractKeyFactsStrategy, TokenCounter
...
class TestTieredCompressionStrategy:
    ...
    def test_tiered_compression(self):
        ...
        from agentmemory.compression import TieredCompressionStrategy, TokenCounter
...
class TestContextCompressor:
    ...
    def test_add_custom_strategy(self):
        ...
        from agentmemory.compression import (
            ContextCompressor, 
            CompressionStrategy,
            TokenCounter,
        )
        from agentmemory.compression.strategies import CompressionResult
    ...
    def test_compression_modes(self):
        ...
        from agentmemory.compression import ContextCompressor, CompressionMode, CompressionConfig
    ...
    def test_message_class(self):
        ...
        from agentmemory.compression import Message, MessageRole
...
class TestConvenienceFunctions:
    ...
    def test_compress_context(self):
        ...
        from agentmemory.compression.compressor import compress_context
    ...
    def test_needs_compression_function(self):
        ...
        from agentmemory.compression.compressor import needs_compression
