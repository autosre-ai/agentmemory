...
def get_context_compressor():
    ...
    from agentmemory.compression import ContextCompressor, CompressionConfig, Message
    return ContextCompressor, CompressionConfig, Message


def get_audit_logger():
    """Lazy import AuditLogger."""
    from agentmemory.security import AuditLogger
    return AuditLogger
...
def team_merge(ctx, source_branch: str, strategy: str):
    ...
    TeamMemoryStore = get_team_memory_store()
    from agentmemory.team import ConflictResolution
...
def compress_conversation(file: str, max_tokens: int, reserve: int, mode: str,
    ...
    from agentmemory.compression import CompressionMode
...
def get_api_server():
    ...
    from agentmemory.api import run_server, APIConfig, set_config
...
def get_io_module():
    ...
    from agentmemory import io as io_module
    return io_module
...
def get_dashboard_module():
    ...
    from agentmemory.dashboard import DashboardServer, DashboardConfig, AnalyticsEngine
