...
from agentmemory.store.embeddings import (
    EmbeddingProvider,
    RerankerProvider,
    normalize_embedding,
...
class TestVectorSearch:
    ...
    def test_vector_search_without_provider(self, store):
        ...
        from agentmemory.store.exceptions import MemoryStoreError
...
class TestSentenceTransformers:
    ...
    def test_real_embedding_provider(self):
        ...
        from agentmemory.store import SentenceTransformerProvider
...
class TestCrossEncoder:
    ...
    def test_real_reranker(self):
        ...
        from agentmemory.store import CrossEncoderReranker
