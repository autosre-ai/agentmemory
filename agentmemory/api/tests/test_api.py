...
def app(test_config):
    ...
    from agentmemory.api import create_app, set_config
    from agentmemory.api.dependencies import reset_memory_store
...
class TestJWTAuth:
    ...
    def test_create_and_verify_token(self, test_config):
        ...
        from agentmemory.api.auth import create_access_token, verify_token
    ...
    def test_expired_token(self, test_config):
        ...
        from agentmemory.api.auth import create_access_token, verify_token, AuthenticationError
    ...
    def test_invalid_token(self, test_config):
        ...
        from agentmemory.api.auth import verify_token, AuthenticationError
